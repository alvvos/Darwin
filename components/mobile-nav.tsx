...
export function MobileNav({ nav, primaryServices, secondaryServices }: Props) {
  ...
  const panel = (
    <div className={`fixed top-20 inset-x-0 bottom-0 bg-white dark:bg-[#050505] z-[200] overflow-y-auto border-t border-zinc-200 dark:border-white/5 transition-opacity duration-200 ${open ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
      <nav className="container mx-auto px-6 py-4 flex flex-col">
        ...
        <div className="border-b border-zinc-100 dark:border-zinc-800">
          <div className="flex items-center justify-between py-4">
            <Link href="/soluciones" onClick={close}
