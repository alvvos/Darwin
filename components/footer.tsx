      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-zinc-500 dark:text-zinc-400 font-light leading-relaxed mt-4">
              {f.tagline}
            </p>
          </div>
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-4">
              ...
              <Link href="/soluciones" className="text-sm text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">
                {f.nav_soluciones}
              </Link>
          ...
          <div>
            <h4 className="text-zinc-900 dark:text-white font-medium mb-6">{f.legal}</h4>
            <nav className="flex flex-col space-y-4">
